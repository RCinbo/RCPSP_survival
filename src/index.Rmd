...
```{r display-species-analysis, results = "asis", echo = FALSE, eval = FALSE}
...
```{r display-CNC, results = "asis", echo = FALSE}
rmd <- knit_expand("_cv_analysis_parameter.Rmd", id = "CNC")
```

```{r display-AD, results = "asis", echo = FALSE}
rmd <- knit_expand("_cv_analysis_parameter.Rmd", id = "AD")
```